...
import com.example.mediconnect.AdminService.dto.DoctorId;
import com.example.mediconnect.AdminService.dto.UserId;
...
public class Producer {
    ...
    public void ApproveDoctor(ApproveRequest request) {
        ...
        kafkaTemplate.send(approveDctr, message);
    }
    ...
    public void sendBlockDoctor(DoctorId doctorId) {
        ...
        kafkaTemplate.send(DrblockTopicName, message);
